...
class arthurjames::profile_graphite (
  ...
  $carbon_max_creates_per_minute = 10000,
  $carbon_max_updates_per_second = 2000,
  ...
  class { 'carbon':
    ...
    local_data_dir         => $carbon_local_data_dir,
    ...
    pid_dir                => $carbon_pid_dir,
    storage_aggregations   => $carbon_storage_aggregations,
    storage_dir            => $storage_dir,
    storage_schemas        => $carbon_storage_schemas,
    carbon_version         => $carbon_version,
    enable_carbon_cache    => $carbon_cache_enabled,
